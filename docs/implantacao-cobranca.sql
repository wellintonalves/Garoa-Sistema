-- Aplicar somente após backup verificado e autorização específica.
BEGIN;
SET LOCAL lock_timeout = '5s';
SET LOCAL statement_timeout = '120s';
-- Diagnóstico somente leitura. Não executar automaticamente.
-- CreateEnum
...
-- AlterTable
ALTER TABLE "usuarios" ADD COLUMN     "aceiteDocumentosEm" TIMESTAMP(3),
...
-- Barbearias anteriores à implantação não recebem um novo teste grátis.
